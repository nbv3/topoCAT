...
/**
 * Algorithm for computing 1-dimensional persistence (RCA1 == M12), using a 
 * standard "reference" implementation (no speed-up using our special data structures)
 * 
 ...
 */
public class AlgorithmM12ref extends Task {
	...
	public AlgorithmM12ref( Settings _processData ) throws Exception {
    ...
    protected void computeM12() throws Exception  {
    	...
    	if ( !suppressAllOutput ) {
	    	...
	    	strBufCollectedFeedback.append( "\n" + TDA.APPLICATION_NAME + ": Computing " + TDA.UI_TASK_M12ref );
	    	strBufCollectedFeedback.append( "\n------------------------------------------------- " );
    	}
